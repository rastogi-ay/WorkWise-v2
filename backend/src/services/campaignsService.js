import { CAMPAIGNS_FEATURE_ID, FeatureDeniedError } from '../stigg/constants.js';
import { estimateCreditUsage, reportUsage } from '../stigg/stiggClient.js';

async function createCampaign(serverApiKey, customerId) {
  ...
  const reportedUsage = await reportUsage(serverApiKey, customerId, CAMPAIGNS_FEATURE_ID, 1);
  return reportedUsage;
}

async function getCampaignsCreditRate(serverApiKey, customerId) {
